...
Implements: IDisposable
  ...
  METHODS:
    ...
    FamilyInstance GetTileFamilyInstance(GridNode gridNode, int tileIndex)
      ...
      Returns: A FamilyInstance object. Returns if the property is not a FamilySymbol. Returns if the grid node is not a "seed node", or if the tile is omitted due to boundary conditions.
    Reference GetTileReference(GridNode gridNode, int tileIndex)
      ...
      @tileIndex: An integer between 0 and T-1, where T is .
...
Implements: IDisposable
  ...
  PROPERTIES:
    ...
    bool IsDetached { get; }
      Description: Identifies if a workshared document is detached. Also, see
    ...
    bool IsWorkshared { get; }
      Description: Identifies if worksharing (i.e. editing permissions and multiple worksets) have been enabled in the document. Also, see
  ...
  METHODS:
    ...
    bool Equals(object obj)
      Description: Determines whether the specified equals to this .
    ...
    DocumentDifference GetChangedElements(Guid baseVersionGUID)
      ...
      @baseVersionGUID: GUID of base version(excluded) to compare. This GUID should be retrieved from property . Empty GUID is allowed to retrieve changes of each version in the document.
    ...
    Element GetElement(string uniqueId)
      ...
      @uniqueId: The element unique id, whose referenced Element will be retrieved from the model.
      Returns: The element referenced by the input argument.
    ...
    Subelement GetSubelement(string uniqueId)
      ...
      @uniqueId: The unique id that identifies element or subelement.
      Returns: The subelement referenced by the input argument.
    ...
    void MakeTransientElements(ITransientElementMaker maker)
      ...
      @maker: An instance of a class that implements the interface. The maker will be called to create element(s) which would become transient.

...
Remarks: To create a new instance, use to specify a connector, or to specify the centerline of a straight element, for the fabrication routing end point.
Implements: IDisposable

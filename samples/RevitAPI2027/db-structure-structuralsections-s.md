...
[CLASS] StructuralSectionConcreteI
Full Name: Autodesk.Revit.DB.Structure.StructuralSections.StructuralSectionConcreteI
Description: Defines parameters for parameterized concrete I structural section.
Inherits: StructuralSectionRectangular

  CONSTRUCTORS:
    new StructuralSectionConcreteI(double width, double height, double centroidHorizontal, double centroidVertical, double principalAxesAngle, double sectionArea, double perimeter, double nominalWeight, double momentOfInertiaStrongAxis, double momentOfInertiaWeakAxis, double elasticModulusStrongAxis, double elasticModulusWeakAxis, double plasticModulusStrongAxis, double plasticModulusWeakAxis, double torsionalMomentOfInertia, double torsionalModulus, double warpingConstant, double shearAreaStrongAxis, double shearAreaWeakAxis, double topFlangeThickness, double topFlangeWidth, double bottomFlangeThickness, double bottomFlangeWidth, double webThickness)
      Description: Creates a new instance of Structural Section Concrete I shape with the associated set of parameters, used to attach to structural element.
      @width: Section width.
      @height: Section height, depth.
      @centroidHorizontal: Distance from centroid to the left extremites along horizontal axis.
      @centroidVertical: Distance from centroid to the upper extremites along vertical axis.
...
[CLASS] StructuralSectionConcreteL
Full Name: Autodesk.Revit.DB.Structure.StructuralSections.StructuralSectionConcreteL
Description: Defines parameters for parameterized concrete L structural section.
Inherits: StructuralSectionRectangular

  CONSTRUCTORS:
    new StructuralSectionConcreteL(double width, double height, double centroidHorizontal, double centroidVertical, double principalAxesAngle, double sectionArea, double perimeter, double nominalWeight, double momentOfInertiaStrongAxis, double momentOfInertiaWeakAxis, double elasticModulusStrongAxis, double elasticModulusWeakAxis, double plasticModulusStrongAxis, double plasticModulusWeakAxis, double torsionalMomentOfInertia, double torsionalModulus, double warpingConstant, double shearAreaStrongAxis, double shearAreaWeakAxis, double cutWidth, double cutHeight)
      Description: Creates a new instance of Structural Section Concrete L shape with the associated set of parameters, used to attach to structural element.
      @width: Section width.
      @height: Section height, depth.
      @centroidHorizontal: Distance from centroid to the left extremites along horizontal axis.
      @centroidVertical: Distance from centroid to the upper extremites along vertical axis.
      ...
      @shearAreaStrongAxis: Shear area (reduced extreme shear stress coefficient) in the direction of strong axis (Wq).
      @shearAreaWeakAxis: Shear area (reduced extreme shear stress coefficient) in the direction of weak axis (Wq).
      @cutWidth: Cut Width: the width of the cut in a rectangle-cut section shape.
      @cutHeight: Cut Height: the height of the cut in a rectangle-cut section shape.

  PROPERTIES:
    double CutHeight { get; set; }
      Description: Cut Height: the height of the cut in a rectangle-cut section shape.
    double CutWidth { get; set; }
      Description: Cut Width: the width of the cut in a rectangle-cut section shape.

--------------------------------------------------------------------------------

[CLASS] StructuralSectionConcretePolygon
Full Name: Autodesk.Revit.DB.Structure.StructuralSections.StructuralSectionConcretePolygon
Description: Defines parameters for parameterized concrete polygon structural section.
Inherits: StructuralSectionRound

  CONSTRUCTORS:
    new StructuralSectionConcretePolygon(double diameter, double centroidHorizontal, double centroidVertical, double principalAxesAngle, double sectionArea, double perimeter, double nominalWeight, double momentOfInertiaStrongAxis, double momentOfInertiaWeakAxis, double elasticModulusStrongAxis, double elasticModulusWeakAxis, double plasticModulusStrongAxis, double plasticModulusWeakAxis, double torsionalMomentOfInertia, double torsionalModulus, double warpingConstant, double shearAreaStrongAxis, double shearAreaWeakAxis, int sides, StructuralSectionPolygonDefinition polygonDefinition)
      Description: Creates a new instance of Structural Section Concrete Polygon shape with the associated set of parameters, used to attach to structural element.
      @diameter: The diameter of the inscribed or circumscribed circle.
      @centroidHorizontal: Distance from centroid to the left extremites along horizontal axis.
      @centroidVertical: Distance from centroid to the upper extremites along vertical axis.
      @principalAxesAngle: Rotation angle between the principal axes and cross section reference planes.
      @sectionArea: Cross section area.
      ...
      @shearAreaStrongAxis: Shear area (reduced extreme shear stress coefficient) in the direction of strong axis (Wq).
      @shearAreaWeakAxis: Shear area (reduced extreme shear stress coefficient) in the direction of weak axis (Wq).
      @sides: Number of sides of the polygon contour. Must between 3 and 36.
      @polygonDefinition: Indicates whether the polygon contour is inscribed or circumscribed.
      Throws ArgumentOutOfRangeException: A value passed for an enumeration argument is not a member of that enumeration

  PROPERTIES:
    StructuralSectionPolygonDefinition PolygonDefinition { get; set; }
      Description: Indicates whether the polygon contour is inscribed or circumscribed.
    int Sides { get; set; }
      Description: Number of sides of the polygon contour.
...
[ENUM] StructuralSectionPolygonDefinition
Full Name: Autodesk.Revit.DB.Structure.StructuralSections.StructuralSectionPolygonDefinition
Description: Indicates how the structural section polygon contour is defined.
Inherits: Enum

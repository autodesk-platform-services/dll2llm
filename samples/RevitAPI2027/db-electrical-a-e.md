...
[CLASS] CableSize
Full Name: Autodesk.Revit.DB.Electrical.CableSize
Description: This class represents the definition of Cable Size data.
Implements: IDisposable

  PROPERTIES:
    string Comments { get; set; }
      Description: The comments of this Cable Size.
    ElementId GroundConductorSize { get; set; }
      Description: The size of a Ground Conductor.
    ElementId HotConductorSize { get; set; }
      Description: The size of a Hot Conductor.
    ElementId Id { get; }
      Description: The Cable Size id.
    bool IsValidObject { get; }
      Description: Specifies whether the .NET object represents a valid Revit entity.
    string Name { get; set; }
      Description: The name of this Cable Size.
    ElementId NeutralConductorSize { get; set; }
      Description: The size of a Neutral Conductor.
    int NumberOfGroundConductors { get; set; }
      Description: The number of Ground Conductors.
    int NumberOfHotConductors { get; set; }
      Description: The number of Hot Conductors.
    int NumberOfNeutralConductors { get; set; }
      Description: The number of Neutral Conductors.
    int NumberOfOtherConductors { get; set; }
      Description: The number of Other Conductors.
    ElementId OtherConductorSize { get; set; }
      Description: The size of an Other Conductor.

  METHODS:
    static CableSize Create(Document document)
      Description: Creates a Cable Size.
      @document: The document.
      Returns: The newly created Cable Size data.
    ...
    void Dispose()
    CableSize Duplicate()
      Description: Duplicates this Cable Size.
      Returns: The duplicated Cable Size data.
    static CableSize GetCableSize(Document document, ElementId cableSizeId)
      Description: Gets the Cable Size data by given Cable Size id.
      @document: The document.
      @cableSizeId: The Cable Size id.
      Returns: The Cable Size data.
      Throws ArgumentException: document is not a project document.
      Throws ArgumentNullException: A non-optional argument was null
      Throws InvalidOperationException: The document is in failure mode: an operation has failed, and Revit requires the user to either cancel the operation or fix the problem (usually by deleting certain elements).
    static ElementId GetCableSizeIdByName(Document document, string name)
      Description: Gets the Cable Size id by given Cable Size name.
      @document: The document.
      @name: The Cable Size name.
      Returns: The Cable Size id.
      ...
      Throws ArgumentNullException: A non-optional argument was null
      Throws InvalidOperationException: The document is in failure mode: an operation has failed, and Revit requires the user to either cancel the operation or fix the problem (usually by deleting certain elements).
    static IList<ElementId> GetCableSizeIds(Document document)
      Description: Gets all the Cable Size ids in the given document, sorted by name.
      @document: The document.
      Returns: All the Cable Size ids in this document.
      Throws ArgumentException: document is not a project document.
      Throws ArgumentNullException: A non-optional argument was null
      Throws InvalidOperationException: The document is in failure mode: an operation has failed, and Revit requires the user to either cancel the operation or fix the problem (usually by deleting certain elements).
...
[CLASS] CableType
Full Name: Autodesk.Revit.DB.Electrical.CableType
Description: This class represents a cable type.
Inherits: ElementType

  PROPERTIES:
    ElementId ConductorMaterial { get; set; }
      Description: The Conductor Material of this Cable Type.
    CoreType CoreType { get; set; }
      Description: The core type of the cable type.
    ElementId InsulationMaterial { get; set; }
      Description: The Conductor Insulation Material of this Cable Type.
    ElementId TemperatureRating { get; set; }
      Description: The Conductor Temperature Rating of this Cable Type.

  METHODS:
    static CableType Create(Document document)
      Description: Creates a Cable Type.
      @document: The document where the new Cable Type will be created.
      Returns: The newly created Cable Type.
      Throws ArgumentException: document is not a project document.
      Throws ArgumentNullException: A non-optional argument was null
      Throws ModificationForbiddenException: The document is in failure mode: an operation has failed, and Revit requires the user to either cancel the operation or fix the problem (usually by deleting certain elements). -or- The document is being loaded, or is in the midst of another sensitive process.
      Throws ModificationOutsideTransactionException: The document has no open transaction.
    CableType Duplicate()
      Description: Duplicates this Cable Type.
      Returns: The duplicated Cable Type element.
    static ElementId GetCableTypeId(Document document, string name)
      Description: Gets the Cable Type id by given cable type name.
      @document: The document.
      @name: The Cable Type name.
      Returns: The Cable Type id. InvalidElementId will be returned if no Cable Type by given name.
      Throws ArgumentException: document is not a project document. -or- name cannot include prohibited characters, such as "{, }, [, ], |, ;, less-than sign, greater-than sign, ?, `, ~". -or- name is an empty string.
      Throws ArgumentNullException: A non-optional argument was null
      Throws InvalidOperationException: The document is in failure mode: an operation has failed, and Revit requires the user to either cancel the operation or fix the problem (usually by deleting certain elements).
    static IList<ElementId> GetCableTypeIds(Document document)
      Description: Gets all the Cable Types in the given document, sorted by name.
      @document: The document.
      Returns: All the Cable Type ids in this document.
      Throws ArgumentException: document is not a project document.
      Throws ArgumentNullException: A non-optional argument was null
      Throws InvalidOperationException: The document is in failure mode: an operation has failed, and Revit requires the user to either cancel the operation or fix the problem (usually by deleting certain elements).
    IList<ElementId> GetUsableCableSizeIds()
      Description: Gets all the Cable Sizes that can be used by this Cable Type, sorted by name.
      Returns: All the Cable Size ids that can be used by this Cable Type.
    bool IsCableSizeUsable(ElementId cableSizeId)
      Description: Checks whether the Cable Size can be used by this Cable Type or not.
      @cableSizeId: The Cable Size id.
      Returns: True if the Cable Size can be used by this Cable Type.
      Throws ArgumentException: The id is not a Cable Size id.
      Throws ArgumentNullException: A non-optional argument was null
    void SetCableSizeUsable(ElementId cableSizeId, bool usable)
      Description: Marks the Cable Size can be used by this Cable Type.
      @cableSizeId: The Cable Size id.
      @usable: The Cable Size can be used by this Cable Type or not.
      Throws ArgumentException: The id is not a Cable Size id.
      Throws ArgumentNullException: A non-optional argument was null
...
Full Name: Autodesk.Revit.DB.Electrical.ConductorMaterial
Description: This class represents the definition of Conductor Material data.
Implements: IDisposable

  PROPERTIES:
    ElementId Id { get; }
      Description: The Conductor Material id.
    bool IsValidObject { get; }
      Description: Specifies whether the .NET object represents a valid Revit entity.
    string Name { get; set; }
      Description: The Conductor Material name.

  METHODS:
    static ConductorMaterial Create(Document document)
      Description: Creates a Conductor Material.
      @document: The document.
      Returns: The newly created Conductor Material data.
      Throws ArgumentException: document is not a project document.
      Throws ArgumentNullException: A non-optional argument was null
      Throws ModificationForbiddenException: The document is in failure mode: an operation has failed, and Revit requires the user to either cancel the operation or fix the problem (usually by deleting certain elements). -or- The document is being loaded, or is in the midst of another sensitive process.
      Throws ModificationOutsideTransactionException: The document has no open transaction.
    void Dispose()
    static ConductorMaterial GetConductorMaterial(Document document, ElementId conductorMaterialId)
      Description: Gets the Conductor Material data by given Conductor Material id.
      @document: The document.
      @conductorMaterialId: The Conductor Material id.
      Returns: The Conductor Material data.
      Throws ArgumentException: document is not a project document. -or- The id is not a Conductor Material id.
      Throws ArgumentNullException: A non-optional argument was null
      Throws InvalidOperationException: The document is in failure mode: an operation has failed, and Revit requires the user to either cancel the operation or fix the problem (usually by deleting certain elements).
    static ElementId GetConductorMaterialIdByName(Document document, string name)
      Description: Gets the Conductor Material id by given Conductor Material name.
      @document: The document.
      @name: The Conductor Material name.
      Returns: The Conductor Material id.
      Throws ArgumentException: document is not a project document. -or- name cannot include prohibited characters, such as "{, }, [, ], |, ;, less-than sign, greater-than sign, ?, `, ~". -or- name is an empty string.
      Throws ArgumentNullException: A non-optional argument was null
      Throws InvalidOperationException: The document is in failure mode: an operation has failed, and Revit requires the user to either cancel the operation or fix the problem (usually by deleting certain elements).
    static IList<ElementId> GetConductorMaterialIds(Document document)
      Description: Gets all the Conductor Material ids in the given document, sorted by name.
      @document: The document.
      Returns: All the Conductor Material ids in this document.
      Throws ArgumentException: document is not a project document.
      Throws ArgumentNullException: A non-optional argument was null
      Throws InvalidOperationException: The document is in failure mode: an operation has failed, and Revit requires the user to either cancel the operation or fix the problem (usually by deleting certain elements).
...
[CLASS] ConductorSize
Full Name: Autodesk.Revit.DB.Electrical.ConductorSize
Description: This class represents the definition of Conductor Size data.
Implements: IDisposable

  PROPERTIES:
    double Diameter { get; set; }
      Description: The diameter of the conductor.
    ElementId Id { get; }
      Description: The Conductor Size id.
    bool IsValidObject { get; }
      Description: Specifies whether the .NET object represents a valid Revit entity.
    string Name { get; set; }
      Description: The Conductor Size name.

  METHODS:
    static ConductorSize Create(Document document)
      Description: Creates a Conductor Size.
      @document: The document.
      Returns: The newly created Conductor Size data.
      Throws ArgumentException: document is not a project document.
      Throws ArgumentNullException: A non-optional argument was null
      Throws ModificationForbiddenException: The document is in failure mode: an operation has failed, and Revit requires the user to either cancel the operation or fix the problem (usually by deleting certain elements). -or- The document is being loaded, or is in the midst of another sensitive process.
      Throws ModificationOutsideTransactionException: The document has no open transaction.
    void Dispose()
    static ConductorSize GetConductorSize(Document document, ElementId conductorSizeId)
      Description: Gets the Conductor Size data by given Conductor Size id.
      @document: The document.
      @conductorSizeId: The Conductor Size id.
      Returns: The Conductor Size data.
      Throws ArgumentException: document is not a project document. -or- The id is not a Conductor Size id.
      Throws ArgumentNullException: A non-optional argument was null
      Throws InvalidOperationException: The document is in failure mode: an operation has failed, and Revit requires the user to either cancel the operation or fix the problem (usually by deleting certain elements).
    static ElementId GetConductorSizeIdByName(Document document, string name)
      Description: Gets the Conductor Size id by given Conductor Size name.
      @document: The document.
      @name: The Conductor Size name.
      Returns: The Conductor Size id.
      Throws ArgumentException: document is not a project document. -or- name cannot include prohibited characters, such as "{, }, [, ], |, ;, less-than sign, greater-than sign, ?, `, ~". -or- name is an empty string.
      Throws ArgumentNullException: A non-optional argument was null
      Throws InvalidOperationException: The document is in failure mode: an operation has failed, and Revit requires the user to either cancel the operation or fix the problem (usually by deleting certain elements).
    static IList<ElementId> GetConductorSizeIds(Document document)
      Description: Gets all the Conductor Size ids in the given document, sorted by name.
      @document: The document.
      Returns: All the Conductor Size ids in this document.
      Throws ArgumentException: document is not a project document.
      Throws ArgumentNullException: A non-optional argument was null
      Throws InvalidOperationException: The document is in failure mode: an operation has failed, and Revit requires the user to either cancel the operation or fix the problem (usually by deleting certain elements).
...
[ENUM] CoreType
Full Name: Autodesk.Revit.DB.Electrical.CoreType
Description: An enumerated type to list all core types.
Inherits: Enum
...
Description: This class represents per phase values including current and power.
Implements: IDisposable

  PROPERTIES:
    double CurrentPhaseA { get; }
      Description: The effective value of current on electrical phase A.
    double CurrentPhaseB { get; }
      Description: The effective value of current on electrical phase B.
    double CurrentPhaseC { get; }
      Description: The effective value of current on electrical phase C.
    bool IsValidObject { get; }
      Description: Specifies whether the .NET object represents a valid Revit entity.
...
Inherits: MEPSystem
  ...
  PROPERTIES:
    ...
    ElementId CableSize { get; set; }
      Description: The Cable Size of the Electrical System.
    ElementId CableType { get; set; }
      Description: The Cable Type of the Electrical System.
    ...
    ElementId GroundConductorSize { get; }
      Description: The size of a Ground Conductor in the Electrical System.
    ...
    ElementId HotConductorSize { get; }
      Description: The size of a Hot Conductor in the Electrical System.
    ...
    ElementId NeutralConductorSize { get; }
      Description: The size of a Neutral Conductor in the Electrical System.
    int NeutralConductorsNumber { get; }
      Description: The NeutralConductors Number of the Electrical System.
    ElementId OtherConductorSize { get; }
      Description: The size of an Other Conductor in the Electrical System.
    int OtherConductorsNumber { get; }
      Description: The OtherConductors Number of the Electrical System.

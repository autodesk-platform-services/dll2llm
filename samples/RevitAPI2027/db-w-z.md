...
Inherits: HostObject
  ...
  METHODS:
    ...
    bool CanSetHostWall(ElementId hostWallId)
      Description: Checks whether this wall can be associated with the specified host wall.
      @hostWallId: The element ID of the host wall to check association against.
      Returns: True if the wall can be associated with the specified host wall.
      Throws ArgumentNullException: A non-optional argument was null
    ...
    ElementId GetHostWallId()
      Description: Gets the element ID of the host wall that this wall is associated with.
      Returns: The element ID of the host wall that this wall is associated with, or invalidElementId if the wall is not associated with any host wall.
    ...
    void SetHostWallId(ElementId hostWallId)
      Description: Associates this wall with the specified host wall. If the host wall is set, this wall will follow the host wall to move or change slanted angle. The Hosted parameter will be shown in schedule and view filter.
      @hostWallId: The element ID of the host wall to associate with. To disassociate the wall from its current host wall, use invalidElementId. If the wall is already associated with the specified host wall, this function does nothing.
      Throws ArgumentNullException: A non-optional argument was null
      Throws InvalidOperationException: Either wall is not qualified for the association. E.g. The wall is a stacked wall.The association would create a circular dependency between walls.The wall spans do not overlap.The walls are misaligned and cannot be associated.A pinned wall cannot participate in the association operation.

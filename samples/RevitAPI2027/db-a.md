...
Implements: IDisposable
  ...
  PROPERTIES:
    ...
    static Guid RevitApplicationId { get; }
      Description: Gets Revit Application native GUID.
...
[ABSTRACT CLASS] AnnotationFamilyUtils
Full Name: Autodesk.Revit.DB.AnnotationFamilyUtils
Description: Utility functions for elements in annotation families.

  METHODS:
    static bool HasExcludeFromLeaderOutline(Element element)
      Description: Checks if the element supports the EXCLUDE_FROM_LEADER_OUTLINE parameter.
      @element: The element to check.
      Returns: True if the element has the EXCLUDE_FROM_LEADER_OUTLINE parameter, false otherwise.
      Throws ArgumentNullException: A non-optional argument was null
    static bool HasLeaderSnapReference(Element element)
      Description: Checks if the element supports the LEADER_SNAP_REFERENCE parameter.
      @element: The element to check.
      Returns: True if the element has the LEADER_SNAP_REFERENCE parameter, false otherwise.
      Throws ArgumentNullException: A non-optional argument was null
    static bool IsExcludedFromLeaderOutline(Element element)
      Description: Checks if the element is excluded from the annotation outline used by leaders.
      @element: The element to check.
      Returns: True if the element is excluded from the leader outline, false otherwise.
      Throws ArgumentException: element doesn't support the EXCLUDE_FROM_LEADER_OUTLINE parameter.
      Throws ArgumentNullException: A non-optional argument was null
    static bool IsLeaderSnapReference(Element element)
      Description: Checks if the element is a leader snap reference for annotation leader snapping.
      @element: The element to check.
      Returns: True if the element is a leader snap reference, false otherwise.
      Throws ArgumentException: element doesn't support the LEADER_SNAP_REFERENCE parameter.
      Throws ArgumentNullException: A non-optional argument was null
    static void SetIsExcludedFromLeaderOutline(Element element, bool isExcluded)
      Description: Sets if the element is excluded from the annotation outline used by leaders.
      @element: The element to set.
      @isExcluded: Pass true to exclude the element from the leader outline, false otherwise.
      Throws ArgumentException: element doesn't support the EXCLUDE_FROM_LEADER_OUTLINE parameter.
      Throws ArgumentNullException: A non-optional argument was null
    static void SetIsLeaderSnapReference(Element element, bool isSnapReference)
      Description: Sets if the element is a leader snap reference for annotation leader snapping.
      @element: The element to set.
      @isSnapReference: Pass true to set the element as a leader snap reference, false otherwise.
      Throws ArgumentException: element doesn't support the LEADER_SNAP_REFERENCE parameter.
      Throws ArgumentNullException: A non-optional argument was null
...
Full Name: Autodesk.Revit.DB.AnnotationLabel
Description: Represents the label elements in annotation families. Labels are used to display parameter values as text.
Inherits: TextElement

  PROPERTIES:
    bool UseNonBreakingSpaces { get; set; }
      Description: If non-breaking spaces should be used in the label text.

  METHODS:
    IList<AnnotationLabelParameterFormatting> GetParameterFormatting()
      Description: Gets the collection of parameter formatting objects for the parameters seen in the label.
      Returns: The collection of parameter formatting objects for the parameters seen in the label.

--------------------------------------------------------------------------------

[CLASS] AnnotationLabelParameterFormatting
Full Name: Autodesk.Revit.DB.AnnotationLabelParameterFormatting
Description: The annotation label parameter formatting settings for a parameter in an annotation label element.
Implements: IDisposable

  PROPERTIES:
    bool IsValidObject { get; }
      Description: Specifies whether the .NET object represents a valid Revit entity.
    bool LeadingLineBreak { get; set; }
      Description: True if a leading line break should be added the leading spaces, prefix and parameter value.
    int LeadingSpaces { get; set; }
      Description: The number of spaces to add before the parameter value.
    string Prefix { get; set; }
      Description: The prefix to add before the parameter value.
    string SampleText { get; set; }
      Description: The sample text to show in the label in the family environment.
    string Suffix { get; set; }
      Description: The suffix to add after the parameter value.

  METHODS:
    void Dispose()
    InternalDefinition GetParameterDefinition(Document document)
      Description: The definition of the parameter shown in the label.
      @document: The document which contains the label and parameter.
      Returns: The definition of the parameter shown in the label.
      Throws ArgumentNullException: A non-optional argument was null
...
Implements: IDisposable
  ...
  METHODS:
    ...
    static bool ElementSupportsMultiAlign(Element element)
      ...
      Throws ArgumentNullException: A non-optional argument was null
    static XYZ GetAnnotationCenter(Element element)
      Description: Gets the center of the alignable element in model space.
      @element: The element for which we are retrieving the center.
      Returns: The center point of the alignable element.

...
Inherits: Element
  ...
  METHODS:
    ...
    double GetValueForHour(int hour)
      ...
      Throws ArgumentOutOfRangeException: hour must be from 0 to 23 inclusive.
    void SetValueForHour(int hour, double usage)
      ...
      Throws ArgumentOutOfRangeException: hour must be from 0 to 23 inclusive. -or- The given value for usage must be non-negative. -or- usage should be less than or equal to 1.
...
Inherits: Element
  ...
  METHODS:
    static BuildingOperatingYearSchedule Create(Document document, BuildingOperatingDaySchedule daySchedule, string name)
      ...
      Throws ArgumentException: The element daySchedule was not found in the given document. -or- name cannot include prohibited characters, such as "{, }, [, ], |, ;, less-than sign, greater-than sign, ?, `, ~". -or- name must be trimmed. -or- name is an empty string or contains only whitespace.
      Throws ArgumentNullException: A non-optional argument was null
    BuildingOperatingDaySchedule GetScheduleForDay(DateTime day)
      ...
      Throws ArgumentOutOfRangeException: day must be in the year 2023.
    void SetScheduleForDay(DateTime day, BuildingOperatingDaySchedule daySchedule)
      ...
      Throws ArgumentException: daySchedule must be in the same document.
      Throws ArgumentNullException: A non-optional argument was null
      Throws ArgumentOutOfRangeException: day must be in the year 2023.
...
Inherits: Element
  ...
  PROPERTIES:
    ...
    double ThermalTransmittance { get; }
      Description: The thermal transmittance value (U-value) of the construction, in W/(m^2*K) (equivalent to kg/(k*s^3)).
...
Inherits: Element
  ...
  METHODS:
    static EnergyAnalysisDetailModel Create(Document document, EnergyAnalysisDetailModelOptions options)
      ...
      Throws ArgumentException: Throws if there are no valid spatial bounding elements, or no valid spatial elements in the document.
      Throws ArgumentNullException: A non-optional argument was null
    ...
    static EnergyAnalysisDetailModel Create(Document document)
      Description: Creates a new energy analysis detailed model.
      @document: The document that contains the physical model of the building.
      Returns: The created model instance.
      Throws ArgumentException: Throws if there are no valid spatial bounding elements, or no valid spatial elements in the document.
...
Inherits: Element
  ...
  METHODS:
    ...
    EnergyAnalysisConstruction GetConstruction()
      Description: Gets the analytic construction this opening is associated with. Null when this opening is a window.
    ...
    EnergyAnalysisWindowType GetWindowType()
      Description: Gets the analytic window type this opening is associated with. Null when this opening is not a window.
...
Inherits: Element
  ...
  PROPERTIES:
    ...
    string CADObjectUniqueId { get; }
      Description: The unique id of the originating Element associated with this EnergyAnalysisSpace at the time of EAM creation.
  ...
  METHODS:
    ...
    IList<Polyloop> GetBoundary()
      Description: Gets the collection of polygons that form the 2D boundary. This method returns a collection of polyloops (planar polygons) that defines an enclosed area measured by interior bounding surfaces, if in rooms and spaces mode. In other modes, returns no polyloops.
      Returns: The collection of polygons that form the 2D boundary.
    IList<Polyloop> GetClosedShell()
      Description: Gets the collection of polygons that form a closed shell. This method returns a collection of polyloops (planar polygons) that defines an enclosed volume measured by interior bounding surfaces, if in rooms and spaces mode. In other modes, returns no polyloops.
...
Inherits: Element
  ...
  PROPERTIES:
    double Azimuth { get; }
      Description: The azimuth angle for this surface, in radians.
    string CADLinkUniqueId { get; }
    ...
    double Tilt { get; }
      Description: The tilt angle for this surface, in radians.
...
Inherits: Element
  ...
  PROPERTIES:
    ...
    double ThermalTransmittance { get; }
      Description: The thermal transmittance value (U-value) of the window type, in W/(m^2*K) (equivalent to kg/(k*s^3)).
...
Inherits: Element
  ...
  PROPERTIES:
    double AirChangesPerHour { get; }
      Description: The outside air rate or air changes per hour as a number between 0 and 10000.
    string CADObjectUniqueId { get; }
      Description: The unique id of the originating CAD object (model element) associated with this zone.
    double CoolingAirTemperature { get; }
      Description: The cooling air temperature in unit Kelvin (K).
    double CoolingSetPoint { get; }
      Description: The cooling temperature set point in unit Kelvin (K).
    double DehumidificationSetPoint { get; }
      Description: The dehumidification set point as a number between 0 and 1.
    double HeatingAirTemperature { get; }
      Description: The cooling air temperature in unit Kelvin (K).
    double HeatingSetPoint { get; }
      Description: The heating temperature set point in unit Kelvin (K).
    double HumidificationSetPoint { get; }
      Description: The humidification set point as a number between 0 and 1.
    double OutsideAirPerArea { get; }
      Description: The outside air per area in unit ft/s.
    double OutsideAirPerPerson { get; }
      Description: The outside air per person in unit ft3/s.
    bool UseAirChangesPerHour { get; }
      Description: Use the air changes per hour.
    bool UseDehumidificationSetPoint { get; }
      Description: Use the dehumidification set point.
    bool UseHumidificationSetPoint { get; }
      Description: Use the humidification set point.
    bool UseOutsideAirPerArea { get; }
      Description: Use the outside air per area.
    bool UseOutsideAirPerPerson { get; }
      Description: Use the outside air per person.

--------------------------------------------------------------------------------

[CLASS] EnergyDataSettings
Full Name: Autodesk.Revit.DB.Analysis.EnergyDataSettings
Description: This element contains settings for Export gbXML and Systems Analysis and project level settings for Energy Analysis. for serialization
Inherits: Element
  ...
  PROPERTIES:
    ...
    double AnalyticalGridCellSize { get; set; }
      Description: The cell size for the uniform cubical grid used when computing the building envelope. This property is ingnored unless AnalysisType is RoomsOrSpaces and BuildingEnvelopeDeterminationMethod is IdentifyExteriorElements.
    double AnalyticalSpaceResolution { get; set; }
      Description: Analytical Space Resolution defines the minimum gap between Revit elements that will be ignored in the identification of energy analytical model spaces. This setting is ignored if AnalysisType is RoomsOrSpaces.
    double AnalyticalSurfaceResolution { get; set; }
      Description: Analytical Surface Resolution defines the smallest dimension of any surface to be included in the energy analytical model. This setting is ignored if AnalysisType is RoomsOrSpaces.
    HVACLoadConstructionClass BuildingConstructionClass { get; set; }
      Description: Used in Heating and Cooling Loads Analysis (ViewHVACLoadsReport). Construction class of building as defined by: loose, medium, tight, or none.
    gbXMLExportBuildingEnvelope BuildingEnvelopeDeterminationMethod { get; set; }
      Description: Indicates if an analysis should be performed to find the model elements that are part of the building envelope.
    ...
    double CoreOffset { get; set; }
      Description: The default offset used to determine the outer perimeter to be divided into zones. Ignored if AnalysisType is not ConceptualMassesAndBuildingElements.
    ...
    bool EnergyModel { get; set; }
      Description: if this is on there should be an energy model dependent on the current AnalysisType if it is off the conceptual energy model should be turned off
    ElementId ExportCategory { get; set; }
      Description: Value is a category indicating which discipline model will be used for GreenBuildingXML export. This property only applies if AnalysisType is RoomsOrSpaces.
    gbXMLExportComplexity ExportComplexity { get; set; }
      Description: Value determines Export Complexity when AnalysisType is RoomsOrSpaces.
    ...
    bool IsExportMullionsEnabled { get; }
      Description: Indicates if mullions are included in GreenBuildingXML export of the detailed model. This property only applies if AnalysisType is RoomsOrSpaces.
    bool IsExportShadingSurfacesEnabled { get; }
      Description: Indicates if "shading surfaces" are included in GreenBuildingXML export of the detailed model. This property only applies if AnalysisType is RoomsOrSpaces.
    bool IsExportSimplifiedCurtainSystemsEnabled { get; }
      Description: Indicates if curtain system geometry is being simplified for GreenBuildingXML export of the detailed model. This property only applies if AnalysisType is RoomsOrSpaces.
    ...
    double PercentageGlazing { get; set; }
      Description: Used for the conceptual energy model (AnalysisType is ConceptualMassesAndBuildingElements). The approximate percentage of the building exterior wall surfaces which are covered by windows or other glazing.
    double PercentageSkylights { get; set; }
      Description: Used for the conceptual energy model (AnalysisType is ConceptualMassesAndBuildingElements). The approximate percentage of the building roof surfaces for masses.
    ...
    HVACLoadLoadsReportType ProjectReportType { get; set; }
      Description: Used in Heating and Cooling Loads Analysis (ViewHVACLoadsReport). Report type: None, simple, standard, detailed, compact.
    ...
    gbXMLServiceType ServiceType { get; set; }
      Description: Used in Heating and Cooling Loads Analysis (ViewHVACLoadsReport). The type of heating or cooling system.
    ...
    double SillHeight { get; set; }
      Description: Used for the conceptual energy model (AnalysisType is ConceptualMassesAndBuildingElements). The height from the nearest lower level used for auto-glazing created on walls.
    double SkylightWidth { get; set; }
      Description: Used for the conceptual energy model (AnalysisType is ConceptualMassesAndBuildingElements). The approximate width used for the skylights in massing instances when the Energy Analytical model is being created.
    double SliverSpaceTolerance { get; set; }
      Description: This property only applies if AnalysisType is RoomsOrSpaces. This value is used to identify sliver spaces, i.e. spaces bounded by parallel surfaces belonging to different rooms.
    ...
    bool UseHeatingCredits { get; set; }
      Description: Used in Heating and Cooling Loads Analysis (ViewHVACLoadsReport). If true, Revit will use heating credits in the final load sum calculations. If false, Revit will ignore heating credits in the final load sum calculations.
    ...
    bool UseOutsideAirPerPerson { get; set; }
      Description: True if user is specifying outside air per person, false otherwise. Deprecated in Revit 2027 and may be removed in a later version of Revit.
  ...
  METHODS:
    ...
    static ElementId GetBuildingConstructionSetElementId(Document ccda)
      ...
      Throws ArgumentNullException: A non-optional argument was null
    static EnergyDataSettings GetEnergyDataSettings(Document doc)
      Description: Gets the energy data settings element in the document.
      @doc: The document where the settings element is found.
      Returns: The element which stores the energy data settings for the document.
      Throws ArgumentNullException: A non-optional argument was null

...
Implements: IDisposable
  ...
  PROPERTIES:
    ...
    bool IsConcreteEnabled { get; set; }
      Description: Checks whether or not the concrete discipline is enabled, and enable or disable it.
    ...
    bool IsPrecastEnabled { get; set; }
      Description: Checks whether or not the precast is enabled, and enable or disable it.
    ...
    string SharedComponentsLocation { get; }
      Description: Location of shared components used by Revit.
  ...
  METHODS:
    ...
    TService GetExtendedApiService<TService>()

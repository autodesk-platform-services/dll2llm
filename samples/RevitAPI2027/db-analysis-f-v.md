...
[ENUM] FlowConvergenceCharacteristic
Full Name: Autodesk.Revit.DB.Analysis.FlowConvergenceCharacteristic
Description: The flow convergence characteristic of the analytical segment cluster.
Inherits: Enum
...
[ENUM] FlowPositionCharacteristic
Full Name: Autodesk.Revit.DB.Analysis.FlowPositionCharacteristic
Description: The flow position characteristic of the analytical segment cluster.
Inherits: Enum
...
[ENUM] FlowTransitionCharacteristic
Full Name: Autodesk.Revit.DB.Analysis.FlowTransitionCharacteristic
Description: The flow transition characteristic of the analytical segment.
Inherits: Enum
...
Inherits: Enum
  ...
  Values:
    ...
    - ServerRoom = 115
    - SleepingQuartersPoliceOrFireStation = 116
    - SortingAreaPostOffice = 117
    - SpecialtyStoreSalesAreaRetail = 118
    - StacksLibrary = 119
    - StairsInactive = 120
    - Stairway = 121
    - SupermarketSalesAreaRetail = 122
    - TerminalTicketCounterTransportation = 123
    - WorkshopWorkshop = 124
    - WorshipPulpitChoirReligious = 125
    - NoOfSpaceTypes = 126
...
Inherits: Element
  ...
  PROPERTIES:
    double Area { get; }
      Description: The area for the zone, in square feet.
    ZoneGeometricDefinition GeometricDefinition { get; }
      Description: The geometric definition for this generic zone.
    double LevelOffset { get; set; }
      Description: The offset distance from this zone to the associated level.
    double OccupiedArea { get; }
      Description: The occupied area for the zone, in square feet.
    double OccupiedVolume { get; }
      Description: The occupied volume for the zone, in cubic feet.
    double Perimeter { get; }
      Description: The perimeter for the zone, in feet.
    double Volume { get; }
      Description: The volume for the zone, in cubic feet.

  METHODS:
    void AddSpaces(ISet<ElementId> spaceIds)
      Description: Adds spaces to the zone.
      @spaceIds: The spaces to be added to the zone. The spaces that are already in the zone will be ignored.
      Throws ArgumentException: The ElementIdSet spaceIds must be all MEP Spaces, and associated with the same level as the zone element.
      Throws ArgumentNullException: A non-optional argument was null
      Throws InvalidOperationException: This generic zone must be space-based.
    void ConvertSpaceBasedToSketchBased(ElementId typeId)
      Description: Converts a space-based generic zone to a sketch-based generic zone.
      @typeId: The sketch-based element type for the new generic zone.
      Throws ArgumentException: The element typeId is not a valid sketch-based zone type.
      Throws ArgumentNullException: A non-optional argument was null
      Throws InvalidOperationException: The document containing this GenericZone is in failure mode: an operation has failed, and Revit requires the user to either cancel the operation or fix the problem (usually by deleting certain elements). -or- The element is a member of a loaded family. -or- The element is a member of a group type that is not being edited. -or- This generic zone must be space-based.
      Throws ModificationForbiddenException: The document containing this GenericZone is in failure mode: an operation has failed, and Revit requires the user to either cancel the operation or fix the problem (usually by deleting certain elements). -or- The document containing this GenericZone is being loaded, or is in the midst of another sensitive process. -or- This GenericZone is an internal element, such as a component of a loaded family or a group type. -or- The document containing this GenericZone is in Group Edit Mode, Sketch Edit Mode, or Paste Mode, and the element is not a member of the group, sketch, or clipboard. -or- This GenericZone is a member of a group or sketch, and the document is not currently editing the group or sketch.
      Throws ModificationOutsideTransactionException: The document containing this GenericZone has no open transaction.
    static GenericZone CreateSketchBased(Document doc, ElementId typeId, string name, GenericZoneDomainData domainData, ElementId levelId, IList<CurveLoop> curveLoops)
      Description: Creates a new instance of a sketch-based generic zone and adds it to the document.
    ...
    static GenericZone CreateSpaceBased(Document doc, ElementId typeId, string name, GenericZoneDomainData domainData, ElementId levelId, ISet<ElementId> spaceIds)
      Description: Creates a new instance of a generic zone using a set of spaces and adds it to the document.
      @doc: The document where the element will be created and added.
      @typeId: The space-based element type for the new generic zone.
      @name: The name of the generic zone to be created.
      @domainData: The specific domain requirements for the generic zone.
      @levelId: The base level on which the generic zone will be created.
      @spaceIds: The associated spaces for the zone.
      Returns: The newly created generic zone.
    ...
    ElementId GetSketchId()
      Description: Gets the sketch id for the generic zone.
      Returns: The sketch element id for the sketch-based generic zone.
      Throws InvalidOperationException: This generic zone must be sketch-based.
    ISet<ElementId> GetSpaceIds()
      Description: Gets a list of ElementIds of the associated spaces for the zone.
      Returns: The associated spaces for the space-based zone.
      Throws InvalidOperationException: This generic zone must be space-based.
    void RemoveSpaces(ISet<ElementId> spaceIds)
      Description: Removes spaces from the zone.
      @spaceIds: The spaces to be removed from the zone. The spaces that are not in the zone will be ignored.
      Throws ArgumentNullException: A non-optional argument was null
      Throws InvalidOperationException: This generic zone must be space-based.
...
Implements: IDisposable
  ...
  PROPERTIES:
    ...
    string Comments { get; }
      Description: The comments for this analytical segment.
    ...
    bool IsValidObject { get; }
      Description: Specifies whether the .NET object represents a valid Revit entity.
    SegmentOverrideType OverrideType { get; }
      Description: The override type of analytical segment pressure loss calculation.
  ...
  METHODS:
    void Dispose()
    string GetFlowCharacteristics(Document doc)
      Description: Gets all flow characteristics of the segment.
      @doc: The document of this segment.
      Returns: All flow characteristics of the segment in one string, empty if all characteristics are undefined.
      Throws ArgumentNullException: A non-optional argument was null
    FlowConvergenceCharacteristic GetFlowConvergenceCharacteristic(Document doc, out FlowPositionCharacteristic outPosition)
      Description: Gets the flow convergence characteristic of the segment.
      @doc: The document of this segment.
      @outPosition: The acquired flow position characteristic of the segment, undefined if the convergence characteristic is undefined.
      Throws ArgumentNullException: A non-optional argument was null
      Throws ArgumentOutOfRangeException: A value passed for an enumeration argument is not a member of that enumeration
    FlowTransitionCharacteristic GetFlowTransitionCharacteristic(Document doc)
      Description: Gets the flow transition characteristic of the segment.
      @doc: The document of this segment.
      Throws ArgumentNullException: A non-optional argument was null
    double GetLossCoefficientOverride()
      Description: Gets the overridden value of loss coefficient, dimensionless.
      Returns: The overridden value, or 0.0 if the loss efficient is not overridden.
    MEPNetworkSegmentId GetNetworkSegmentId()
      Description: Gets the NetworkSegmentId.
    double GetPressureDropOverride()
      Description: Gets the overidden value of pressuer drop, in kg/(ft*s^2).
      Returns: The overridden value, or 0.0 if the pressure drop is not overridden. Note that the value can be negative to indicate the pressure gain at the flow direction.
    static MEPAnalyticalSegment GetSegment(Subelement subElem)
      Description: Gets the analytical segment from the Subelement
      @subElem: The subelement of the analytical segment.
      Throws ArgumentException: The subelement must be a valid analytical segment subelement.
      Throws ArgumentNullException: A non-optional argument was null
    Subelement GetSubelement(Document pADoc)
      Description: Gets the subelement of this segment.
      @pADoc: The document of this segment.
      Returns: The subelement of this segment.
      Throws ArgumentNullException: A non-optional argument was null
    bool IsSegmentOverridable()
      Description: Verifies if the segment can be overridden (e.g., the pressure drop of the pump and curve segments are calculated from the network and cannot be overridden).
      Returns: True if the segment can be overridden for the loss coefficient or pressure drop, false if the segment cannot be overriden.
    void SetComments(MEPAnalyticalModelData analyticalModel, string newComments)
      Description: Sets the comments for this analytical segment.
      @analyticalModel: The analytical model data that this segment belongs to.
      @newComments: The new comments.
      Throws ArgumentNullException: A non-optional argument was null
    void SetLossCoefficientOverride(MEPAnalyticalModelData analyticalModel, double lossCoefficient)
      Description: Sets the overridden value of loss coefficient.
      @analyticalModel: The analytical model data that this segment belongs to.
      @lossCoefficient: The new loss coefficient value, dimensionless.
      Throws ArgumentNullException: A non-optional argument was null
    void SetOverrideType(MEPAnalyticalModelData analyticalModel, SegmentOverrideType overrideType)
      Description: Sets the override type of pressure loss calculation.
      @analyticalModel: The analytical model data that this segment belongs to.
      @overrideType: The new override type.
      Throws ArgumentNullException: A non-optional argument was null
      Throws ArgumentOutOfRangeException: A value passed for an enumeration argument is not a member of that enumeration
      Throws InvalidOperationException: The segment cannot be overridden for the pressure loss calculation.
    void SetPressureDropOverride(MEPAnalyticalModelData analyticalModel, double pressureDrop)
      Description: Sets the overridden value of pressure drop.
      @analyticalModel: The analytical model data that this segment belongs to.
      @pressureDrop: The new pressure drop value, in kg/(ft*s^2). Note that the negative value indicates the pressure gain at the flow direction.
      Throws ArgumentNullException: A non-optional argument was null
...
[ENUM] SegmentOverrideType
Full Name: Autodesk.Revit.DB.Analysis.SegmentOverrideType
Description: The override types of analytical segment pressure drop calculation.
Inherits: Enum

  Values:
    - None = 0
    - OverrideLossCoefficient = 1
    - OverridePressureDrop = 2

--------------------------------------------------------------------------------

[CLASS] SizingCalculator
Full Name: Autodesk.Revit.DB.Analysis.SizingCalculator
Description: Calculates the required duct or pipe size based on the specified parameters and constraints.
Remarks: This class calculates duct and pipe sizes based on various constraints such as flow friction, and velocity. Other parameters are often included in SizingOptions. The size result is also stored in the SizingOptions after the calculation.
Implements: IDisposable

  CONSTRUCTORS:
    new SizingCalculator(Document document)
      Description: Constructs an SizingCalculator instance.
      @document: The document associated with this sizing calculator, used for accessing the calculation service in the settings.
      Throws ArgumentNullException: A non-optional argument was null
  ...
  METHODS:
    void CalculateSizeByFriction(double flow, double friction, SizingOptions sizingOptions)
      Description: Calculates the duct or pipe size based on the specified flow and friction.
      @flow: The flow rate.
      @friction: The desired friction.
      @sizingOptions: The sizing options containing other input sizing parameters (such as density, viscosity, roughness, etc.) and output sizes.
      Throws ArgumentException: The input must be initialized correctly for sizing operation.
      Throws ArgumentNullException: A non-optional argument was null
      Throws ArgumentOutOfRangeException: The given value for flow must be positive. -or- The given value for friction must be positive.
      Throws InvalidOperationException: Failed to calculate the size to satisfy the friction constraint.
    void CalculateSizeByVelocity(double flow, double velocity, SizingOptions sizingOptions)
      Description: Calculates the duct or pipe size based on the specified flow and velocity.
      @flow: The flow rate.
      @velocity: The desired velocity.
      @sizingOptions: The sizing options containing other input sizing parameters (such as density, viscosity, roughness, etc.) and output sizes.
      Throws ArgumentException: The input must be initialized correctly for sizing operation.
      Throws ArgumentNullException: A non-optional argument was null
      Throws ArgumentOutOfRangeException: The given value for flow must be positive. -or- The given value for velocity must be positive.
      Throws InvalidOperationException: Failed to calculate the size to satisfy the velocity constraint.
    void Dispose()
    double EquivalentDiameter(ConnectorProfileType eShape, double widthOrDiameter, double height)
      Description: Calculates the equivalent diameter based on the specified profile type, width, and height.
      @eShape: The shape of the connector profile.
      @widthOrDiameter: The width or diameter of the connector.
      @height: The height of the connector.
      Returns: Returns the calculated equivalent diameter.
      Throws ArgumentOutOfRangeException: A value passed for an enumeration argument is not a member of that enumeration
    double Friction(double flow, SizingOptions options)
      Description: Calculates the friction based on the specified parameters.
      @flow: The flow rate.
      @options: The sizing options containing other input parameters (such as density, viscosity, roughness, size, etc.).
      Returns: Returns the calculated friction.
      Throws ArgumentNullException: A non-optional argument was null
    double Velocity(double flow, SizingOptions options)
      Description: Calculates the velocity based on the specified parameters.
      @flow: The flow rate.
      @options: The sizing options containing other input parameters (such as profile type and size).
      Returns: Returns the calculated velocity.
      Throws ArgumentNullException: A non-optional argument was null

--------------------------------------------------------------------------------

[CLASS] SizingOptions
Full Name: Autodesk.Revit.DB.Analysis.SizingOptions
Description: Contains the options for MEP sizing parameters, such as profile type, material roughness, fluid density and viscosity, minimal and maximal sizes, and etc.
Implements: IDisposable

  CONSTRUCTORS:
    new SizingOptions(Element ductOrPipeCurve)
      Description: Constructs a new instance of the SizingOptions with specified parameters.
      @ductOrPipeCurve: The element of a duct or pipe curve where the sizing parameters are extracted.
      Throws ArgumentException: The element must be a valid duct or pipe curve object.
      Throws ArgumentNullException: A non-optional argument was null
    new SizingOptions()
      Description: Constructs a new instance of the SizingOptions with default parameters.
    new SizingOptions(SizingOptions other)
      Description: Constructs a new copy of the SizingOptions object.
      Throws ArgumentNullException: A non-optional argument was null

  PROPERTIES:
    double Area { get; }
      Description: The area of the specified sizing profile and dimension.
    double Density { get; set; }
      Description: The air or fluid density in kg/ft^3, defaults to the dry air density at 20ÂºC.
    double Diameter { get; }
      Description: The diameter of round duct or pipe in feet.
    ConnectorDomainType DomainType { get; set; }
      Description: The domain type of the options, such as HVAC or Plumbing.
    double Height { get; set; }
      Description: The height of the duct or pipe in feet.
    bool IsValidObject { get; }
      Description: Specifies whether the .NET object represents a valid Revit entity.
    double MaxSize { get; set; }
      Description: The maximal size in feet, defaults to 2 feet.
    double MinSize { get; set; }
      Description: The minimal size in feet, defaults to 0.041666 ft (0.5 inch).
    ConnectorProfileType ProfileType { get; set; }
      Description: The profile type of the options, such as round, rectangular or oval.
    double Roughness { get; set; }
      Description: The material roughness in ft, defaults to 0.0003 ft.
    double Viscosity { get; set; }
      Description: The air or fluid viscosity in kg/(ft*s), defaults to the air dynamic viscosity at 20ÂºC.
    double Width { get; }
      Description: The width of the duct or pipe in feet.

  METHODS:
    void Dispose()
    bool IsValid()
      Description: Checks if the options are valid and ready for sizing operation.
      Returns: Returns true if the options are valid, false otherwise.
    void SetEquivalentHeight(double fixedWidth, ISet<MEPSize> availableSizes)
      Description: Sets the equivalent height based on the specified width.
      @fixedWidth: The new width.
      @availableSizes: The sorted list of available sizes, where the equivalent height will be selected.
      Throws ArgumentNullException: A non-optional argument was null
      Throws ArgumentOutOfRangeException: The given value for fixedWidth must be positive. -or- The fixedWidth must be within the range of availableSizes. -or- The new size must be within the range of available sizes.
    void SetEquivalentWidth(double fixedHeight, ISet<MEPSize> availableSizes)
      Description: Sets the equivalent width based on the specified height.
      @fixedHeight: The new height.
      @availableSizes: The sorted list of available sizes, where the equivalent width will be selected.
      Throws ArgumentNullException: A non-optional argument was null
      Throws ArgumentOutOfRangeException: The given value for fixedHeight must be positive. -or- The fixedHeight must be within the range of availableSizes. -or- The new size must be within the range of available sizes.
    void SetNextAvailableSize(ConnectorProfileType profileType, double width, double height, ISet<MEPSize> availableSizes)
      Description: Sets the next available size based on the specified inner diameter.
      @profileType: The profile type of the duct or pipe, such as round, rectangular or oval.
      @width: The width value that the next available size must exceed.
      @height: The height value that the next available size must exceed.
      @availableSizes: The sorted list of available sizes for both width and height, where the smallest possible size yet larger than the specified value will be selected.
      Throws ArgumentNullException: A non-optional argument was null
      Throws ArgumentOutOfRangeException: The given value for width must be positive. -or- The given value for height must be positive. -or- The width must be within the range of availableSizes. -or- The height must be within the range of availableSizes. -or- A value passed for an enumeration argument is not a member of that enumeration
    void SetNextAvailableSize(double innerDiameter, ISet<MEPSize> availableSizes)
      Description: Sets the next available size based on the specified inner diameter.
      @innerDiameter: The inner diameter threshold that the next available size must exceed.
      @availableSizes: The sorted list of available sizes, where the smallest possible size yet larger than the specified inner diameter will be selected.
      Throws ArgumentNullException: A non-optional argument was null
      Throws ArgumentOutOfRangeException: The given value for innerDiameter must be positive. -or- The innerDiameter must be within the range of availableSizes.
...
[CLASS] ViewHVACLoadsReport
Full Name: Autodesk.Revit.DB.Analysis.ViewHVACLoadsReport
Description: Represents a loads report instance.
Inherits: View

  METHODS:
    static ViewHVACLoadsReport Create(Document document, string viewName)
      Description: Factory method to create a new instance of DBViewHVACLoadsReport.
      @document: The document where the report view is to be created.
    ...
    bool IsAnalysisCompleted()
      Description: Indicates if the heating and cooling loads analysis has completed or not.
      Returns: True if completed, otherwise false.
    void RunLoadsAnalysis()
      Description: Performs a heating and cooling loads analysis for zones and spaces in the energy model.
      Throws InvalidOperationException: A valid energy model is required for loads analysis.
...
Inherits: View
  ...
  METHODS:
    ...
    void RequestSystemsAnalysis(SystemsAnalysisOptions options)
      Description: Requests a new systems analysis to be run in the background.
      ...
      Throws InvalidOperationException: A valid energy model is required for systems analysis. -or- Unable to export the gbxml file or access the weather service.

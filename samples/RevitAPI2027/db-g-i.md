...
Description: This class contains constants identifying parameter groups.
  ...
  PROPERTIES:
    ...
    static ForgeTypeId StairNumberSystemAboveCutMarkGraphics { get; }
      Description: Alternate Graphics for Above Cut Mark.
    static ForgeTypeId StairNumberSystemAboveCutMarkText { get; }
      Description: Alternate Text for Above Cut Mark.
    ...
    static ForgeTypeId Support { get; }
      Description: Supports.
    static ForgeTypeId Sustainability { get; }
...
Implements: IDisposable
  ...
  CONSTRUCTORS:
    new IFCPropertyMappingInfo(bool exportFlag, string ifcPropertyName, ElementId revitPropertyId, string revitPropertyName)
      Description: Constructs a new IFCPropertyMappingInfo with input values. The flag that indicates whether the property is included in export. The property name. The Revit property id. The Revit property name.
      Throws ArgumentNullException: A non-optional argument was null
...
Full Name: Autodesk.Revit.DB.IFCUserDefinedProperty
Description: Represents the IFC property stored in the property set.
Implements: IDisposable

  CONSTRUCTORS:
    new IFCUserDefinedProperty(string ifcPropertyName, ElementId revitPropertyId, string revitPropertyName, string dataType, IFCUserDefinedPropertyType propertyType, string dataTypeDefined)
      Description: Constructs a new IFCUserDefinedProperty with input values. The property name. The Revit property id. The Revit property name. The data type of the property. The type of the property. The defined value data type of the table property.
      Throws ArgumentNullException: A non-optional argument was null
      Throws ArgumentOutOfRangeException: A value passed for an enumeration argument is not a member of that enumeration
    new IFCUserDefinedProperty()
      Description: Constructs a new IFCUserDefinedProperty with default values.

  PROPERTIES:
    string DataType { get; set; }
      Description: The data type of the property.
    string DataTypeDefined { get; set; }
      Description: The defined value data type of the table property.
    string IFCPropertyName { get; set; }
      Description: The IFC property name.
    bool IsValidObject { get; }
      Description: Specifies whether the .NET object represents a valid Revit entity.
    IFCUserDefinedPropertyType PropertyType { get; set; }
...
[CLASS] IFCUserDefinedPropertySet
Full Name: Autodesk.Revit.DB.IFCUserDefinedPropertySet
Description: Represents an element that contains an IFC user-defined property set stored in a Revit document.
Inherits: Element

  PROPERTIES:
    IFCUserDefinedPropertySetType PropertySetType { get; set; }
      Description: The user-defined property set type.

  METHODS:
    void AddProperty(IFCUserDefinedProperty userDefinedProperty)
      Description: Adds a property to the property set.
      Throws ArgumentException: A property set with the given name already exists in the property set.
      Throws ArgumentNullException: A non-optional argument was null
    void ClearPropertySet()
      Description: Removes all properties from the property set.
    IFCUserDefinedPropertySet CopyPropertySet(Document document, string copyPropertySetName)
      Description: Create copy of property set with new name.
      @document: The Revit document to save the copied property set.
      @copyPropertySetName: The name for copied property set name.
      Returns: The copied property set element.
      Throws ArgumentException: The name is empty or already exists.
      Throws ArgumentNullException: A non-optional argument was null
      Throws InvalidOperationException: Failed to create IFCUserDefinedPropertySet element.
    static IFCUserDefinedPropertySet Create(Document document, string name)
      Description: Create an IFC user-defined property set with default values.
      @document: The document where created property set is saved.
      @name: The name specified to this property set.
      Returns: The new property set instance.
      Throws ArgumentException: The name is empty or already exists.
      Throws ArgumentNullException: A non-optional argument was null
    static void ExportToFile(Document document, string fileName)
      Description: Export property sets to a text file.
      @document: The Revit document.
      @fileName: The full text file name.
      Throws ArgumentNullException: A non-optional argument was null
      Throws FileAccessException: Failed to access the text file.
    IFCUserDefinedProperty FindPropertyByName(string name)
      Description: Returns property by name.
      @name: Name of the property to find.
      Returns: The property or if not found.
      Throws ArgumentNullException: A non-optional argument was null
    static IFCUserDefinedPropertySet FindPropertySetByName(Document document, string name)
      Description: Returns property set element by name.
      @document: The document to find the property set with the specified name.
      @name: Name of the property set to find.
      Returns: The property set element, or if not found.
      Throws ArgumentNullException: A non-optional argument was null
    IList<string> GetApplicableEntities()
      Description: Returns the list of IFC entities to which the property set is applicable.
      Returns: The list of IFC entities to which the property set is applicable.
    IList<IFCUserDefinedProperty> GetProperties()
      Description: Returns the collection of properties in the property set.
      Returns: The collection of properties in the property set.
    static IList<IFCUserDefinedPropertySet> ImportFromFile(Document document, string fileName, out bool validUserDefinedPropertySetFile)
      Description: Import property sets from a text file.
      @document: The Revit document.
      @fileName: The full text file name.
      @validUserDefinedPropertySetFile: Whether or not the imported file with property sets is valid.
      Returns: The property set elements.
      Throws ArgumentNullException: A non-optional argument was null
      Throws FileAccessException: Failed to access the text file.
      Throws InvalidOperationException: Failed to create IFCUserDefinedPropertySet.
    bool IsPropertyAMemberOfPropertySet(string propertyName)
      Description: Checks whether a property exists in the property set.
      @propertyName: The property set name.
      Returns: True if the property exists in the property set.
      Throws ArgumentNullException: A non-optional argument was null
    static bool IsValidName(Document document, string name)
      Description: Checks whether the proposed name is valid and not exist in the specified document.
      @document: The document to check
      @name: The name to check.
      Returns: Whether or not the name is valid.
      Throws ArgumentNullException: A non-optional argument was null
    static IList<string> ListPropertySetNames(Document document)
      Description: Returns a list property set names stored in the document.
      @document: The Revit document to retrieve names from.
      Returns: The list of property set names.
      Throws ArgumentNullException: A non-optional argument was null
    void RemoveProperty(string propertyName)
      Description: Removes a property from the property set.
      @propertyName: The name of the property to remove.
      Throws ArgumentException: A property with the given name is not present in the property set.
      Throws ArgumentNullException: A non-optional argument was null
    void SetApplicableEntities(IList<string> applicableEntities)
      Description: Sets the list of IFC entities to which the property set is applicable.
      @applicableEntities: The list of IFC entities to which the property set is applicable.
      Throws ArgumentNullException: A non-optional argument was null
...
[ENUM] IFCUserDefinedPropertySetType
Full Name: Autodesk.Revit.DB.IFCUserDefinedPropertySetType
Description: An enumerated type listing user-defined property set types.
Inherits: Enum
...
[ENUM] IFCUserDefinedPropertyType
Full Name: Autodesk.Revit.DB.IFCUserDefinedPropertyType
Description: An enumerated type listing user-defined property types
Inherits: Enum
...
Inherits: Element
  ...
  METHODS:
    ...
    bool CanLeaderEndConditionBeAssigned(LeaderEndCondition leaderEndCondition)
      ...
      @leaderEndCondition: The LeaderEndCondition that will be checked to see if it can be assigned.
      Returns: True if the LeaderEndCondition of the tag can be assigned, or false otherwise.
      Throws ArgumentOutOfRangeException: A value passed for an enumeration argument is not a member of that enumeration
    bool CanLeaderStartConditionBeAssigned(LeaderStartCondition leaderStartCondition)
      Description: Checks whether the LeaderStartCondition can be changed.
      @leaderStartCondition: The LeaderStartCondition that will be checked to see if it can be assigned.
      Returns: True if the LeaderStartCondition of the tag can be assigned, or false otherwise.
      Throws ArgumentOutOfRangeException: A value passed for an enumeration argument is not a member of that enumeration
    ...
    XYZ GetLeaderEnd(Reference referenceTagged)
      Description: Gets the free end point for the leader to the specified reference.
      @referenceTagged: The reference which is tagged.
      Returns: A point representing the free end location for the leader.
      ...
      Throws ArgumentNullException: A non-optional argument was null
      Throws InvalidOperationException: The IndependentTag object does not have a tag behavior.
    XYZ GetLeaderStart(Reference referenceTagged)
      Description: Gets the free leader start point for the leader to the specified reference.
      @referenceTagged: The reference which is tagged.
      Returns: A point representing the free start location for the leader.
      Throws ArgumentException: There is no leader start because the tag does not use a free start leader or the leader is not visible. -or- The specified reference is not currently tagged.
      Throws ArgumentNullException: A non-optional argument was null
      Throws InvalidOperationException: The IndependentTag object does not have a tag behavior.
    ...
    void SetLeaderEnd(Reference referenceTagged, XYZ freeLeaderEndPoint)
      Description: Sets the free end point for the leader to the specified reference.
      @referenceTagged: The reference which is tagged.
      @freeLeaderEndPoint: A point representing the free end location for the leader.
      Throws ArgumentException: There is no leader end because the tag does not use a free end leader or the leader is not visible. -or- The specified reference is not currently tagged.
      Throws ArgumentNullException: A non-optional argument was null
      Throws InvalidOperationException: The IndependentTag object does not have a tag behavior. -or- For this tag leaders are not allowed.
    void SetLeaderStart(Reference referenceTagged, XYZ freeLeaderStartPoint)
      Description: Sets the free leader start point for the leader to the specified reference.
      @referenceTagged: The reference which is tagged.
      @freeLeaderStartPoint: A point representing the free start location for the leader.
      Throws ArgumentException: There is no leader start because the tag does not use a free start leader or the leader is not visible. -or- The specified reference is not currently tagged.
      Throws ArgumentNullException: A non-optional argument was null
      Throws InvalidOperationException: The IndependentTag object does not have a tag behavior. -or- For this tag leaders are not allowed.
...
Remarks: See also: Autodesk::Revit::DB::IExportContext::OnInstanceBegin. The SymbolGeometryId. contains the data for comparing if two InstanceNode points to the same geometry.
Inherits: GroupNode
